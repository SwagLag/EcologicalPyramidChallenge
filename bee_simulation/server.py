...
model_params = {
    ...
    "min_grd_nectar": UserSettableParameter(
        "slider", "Minimum Nectar Grade", 1, 1, 3, description="Minimum nectar grade available in flowerfields"
    ),
    "max_grd_nectar": UserSettableParameter(
        "slider", "Maximum Nectar Grade", 3, 1, 5, description="Maximum nectar grade available in flowerfields"
    )
}
